...
Por convención, las variables deterministicas se incluyen en el grafo como circulos
pequeños, mientras que las variables aleatorias observadas se muestran como nodos grises,
los nodos incloloros representan variables latentes o no observadas, finalemnte las
aristas, al igual que en los ejemplos anteriores, represetan la dependecia condicional
